...
var Tixia = function(){
	...
	var handleTheme = function(){
		...
		$('#admin-main-wrapper').addClass('show');
	}
	...
	var handleNavigation = function() {
		$(".admin-nav-control").on('click', function() {

			$('#admin-main-wrapper').toggleClass("menu-toggle");
	...
	var handleCurrentActive = function() {
		for (var nk = window.location,
			o = $("ul#admin-menu a").filter(function() {
				return this.href == nk;
			})
			.addClass("mm-active")
			.parent()
	...
	var handleMiniSidebar = function() {
		$("ul#admin-menu>li").on('click', function() {
	...
	var handleMinHeight = function() {
		...
		if (win_h > 0 ? win_h : screen.height) {
			$(".admin-content-body").css("min-height", (win_h + 60) + "px");
		};
	}
	...
	var handleMenuTabs = function() {
		if(screenWidth <= 991 ){
			...
			jQuery('.close-fixed-content').on('click',function(){
				...
				jQuery('#admin-main-wrapper').removeClass('menu-toggle');
				jQuery('.hamburger').show();
			});
		}
	}
