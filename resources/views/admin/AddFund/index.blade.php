                ...
                <div class="admin-card-body">
                    <form class="row g-3" id="fund_req">
                        ...
                        <div class="form-group col-12">
                            ...
                            <input type="text" name="user_id" class="admin-form-control" id="username" placeholder="Station ID"  onblur="checkUserExistedWithBalance(this.value);"/>
                        </div>
                        <div class="form-group col-12">
                        ...
                        <div class="form-group col-12">
                            ...
                            <div class="text-red py-1" id="amount-message"></div>
                        </div>
                        ...
                        <div class="form-group col-12 text-center">
                            <button type="button" class="btn btn-outline-primary" id="signup1" disabled  onclick="fund_req()" >Submit</button>
                        </div>
                    </form>
                </div>
            </div>
