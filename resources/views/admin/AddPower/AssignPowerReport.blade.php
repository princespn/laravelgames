        ...
        <div class="col-md-12">
            <div class="admin-card">
                <div class="admin-card-header">
                    <h4 class="page-title">Assign Primes Report</h4>
                </div>
                <form id="searchForm">
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <table v-once id="manage-user-report" class="display nowrap" style="width: 100%">
                            <thead>
                                <tr>
                                    ...
                                    <th>Username</th>
                                    <th>Full Name</th>
                                    <th>Assigned Primes</th>
                                    <th>Position</th>
                                    <th>Before Left Primes</th>
                                    <th>Before Right Primes</th>
                                    <th>After Left Primes</th>
                                    <th>After Right Primes </th>
                                </tr>
                            </thead>
                        </table>
                    </div>
        ...
        function powerReport() {
            ...
            setTimeout(function() {
                const table = $('#manage-user-report').DataTable({
                    ...
                    ajax: {
                        url: '{{ url('1Rto5efWp86Z/manage-power/assign-primes-report-data') }}',
                        type: 'POST',
                        headers: {
