    ...
    <div class="col-12">
        <div class="admin-card">
            <div class="admin-card-header">
                <h4 class="card-title">Buy Token History</h4>
            </div>
            <form id="searchForm">
                <div class="row">
                    <div class="col-md-12">
            ...
            <div class="admin-card-body">
                <div class="table-responsive admin-table">
                    <table v-once id="buy-token-history" class="display nowrap" style="width: 100%">
                        <thead>
                        <tr>
                            <th>Sr No.</th>
                            <th>Date</th>
...
$(document).ready(function() {
    ...
    var csrf_token = "{{ csrf_token() }}";
     ...
     var table = $("#buy-token-history").DataTable({
        responsive: true,
        retrieve: true,
        destroy: true,
        processing: false,
        ...
        ajax: {
            url: "{{ url('1Rto5efWp86Z/user/buyTokenHistoryData') }}",
            type: "POST",
            headers: {
    ...
    $.ajax({
        ...
        success: function (resp) {
            if (resp.code === 200) {
                ...
                fileLink.setAttribute("download", "BuyTokenReport.xls");
