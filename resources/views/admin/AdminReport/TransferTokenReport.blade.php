    ...
    <div class="col-12">
        <div class="admin-card">
            <div class="admin-card-header">
                <h4 class="card-title">Transfer Token History</h4>
            </div>
            <form id="searchForm">
                <div class="row">
                    <div class="col-md-12">
            ...
            <div class="admin-card-body">
                <div class="table-responsive admin-table">
                    <table v-once id="transfer-token-history" class="display nowrap" style="width: 100%">
                        <thead>
                        <tr>
                            <th>Sr No</th>
                            <th>Date</th>
...
$(document).ready(function() {
    ...
    var csrf_token = "{{ csrf_token() }}";
     ...
     var table = $("#transfer-token-history").DataTable({
        responsive: true,
        retrieve: true,
        destroy: true,
        processing: false,
        ...
        ajax: {
            url: "{{ url('1Rto5efWp86Z/user/transferTokenHistoryData') }}",
            type: "POST",
            headers: {
    ...
    $.ajax({
        ...
        success: function (resp) {
            if (resp.code === 200) {
                ...
                fileLink.setAttribute("download", "TransferTokenReport.xls");
