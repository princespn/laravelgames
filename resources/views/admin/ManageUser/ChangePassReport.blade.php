    ...
    <div class="col-12">
        <div class="admin-card">
            <div class="admin-card-header">
                <h4 class="card-title">Password Change By Admin Report</h4>
            </div>
            <form id="searchForm">
                <div class="row">
                    <div class="col-md-12">
...
$(document).ready(function() {
    ...
    var columns = [
        ...
        },
        {
            render: function (data, type, row) {
                return "Password Change By Admin";
            }
        }
    ];
    var table = $("#manage-user-report").DataTable({
        ...
        ajax: {
            url: "{{ url('1Rto5efWp86Z/get-change-password-data') }}",
            type: "POST",
            headers: {
    ...
    $.ajax({
        ...
        success: function (resp) {
            if (resp.code === 200) {
                ...
                fileLink.setAttribute("download", "ChangePasswordByAdminReport.xls");
