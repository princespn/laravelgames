    ...
    <div class="col-12">
        <div class="admin-card">
            <div class="admin-card-header">
                <h4 class="card-title">View Structure Details</h4>
                <a href="{{ url('1Rto5efWp86Z/user/user-structure-report') }}" class="btn btn-primary float-right">Back</a>
            </div>
            <form id="searchForm">
                <div class="row">
                    <div class="col-md-12">
...
$(document).ready(function() {
    ...
    var table = $("#manage-user-report").DataTable({
        ...
        ajax: {
            url: "{{ url('1Rto5efWp86Z/view-structure-data') }}",
            type: "POST",
            headers: {
    ...
    $.ajax({
        ...
        success: function (resp) {
            if (resp.code === 200) {
                ...
                fileLink.setAttribute("download", "ViewStructureDetails.xls");
