        ...
        <div class="col-12">
            <div class="admin-card">
                <div class="admin-card-header">
                    <h4 class="card-title">User Financial Overview Report</h4>
                </div>
                <form id="searchForm">
                    <div class="row">
                        <div class="col-md-12">
                ...
                <div class="admin-card-body">
                    <div class="table-responsive admin-table">
                        <table id="financial-report" class="display nowrap" style="width: 100%">
                            <thead>
                                <tr>
                                    <th>Sr.No</th>
                                    <th>Station ID</th>
                                    <th>Special Buying Allocation</th>
                                    <th>Special Power Allocation</th>
...
<script>
    $(document).ready(function() {
        ...
        var i = 0;
        var reportsTable = $("#financial-report").DataTable({
            responsive: true,
            lengthMenu: [
            ...
            ajax: {
                url: '{{ url('1Rto5efWp86Z/user-final-overview-report-data') }}',
                type: "POST",
                data: function(d) {
                    i = 0;
                    i = d.start + 1;
