...
@section('content')
        ...
        <div class="col-12">
            <div class="admin-card">
                <div class="admin-card-header">
                    <h4 class="card-title">Update User Address Report</h4>
                </div>
                <form id="searchForm">
                    <div class="row">
                        <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input class="admin-form-control" placeholder="Enter Enter Address" type="text"
                        ...
                        <table id="edit-user-profile-report" class="display nowrap" style="width: 100%">
                            <thead>
                                <tr>
                                    ...
                                    <th>Mobile</th>
                                    <th>Email ID</th>
                                    <th>Old MATIC Address</th>
                                    <th>New MATIC Address</th>
                                    <th>Old USDT.BEP20 Address</th>
                                    <th>New USDT.BEP20 Address</th>
                                    <th>Updated By</th>
                                </tr>
                            </thead>
                        </table>
    ...
    <script>
        ...
        function roiIncomeReport() {
            ...
            setTimeout(function() {
                const table = $("#edit-user-profile-report").DataTable({
                    ...
                    ajax: {
                        url: '{{ url('1Rto5efWp86Z/getuseraddresslogs') }}',
                        type: "POST",
                        headers: {
                    ...
                    columns: [{
                        ...
                        {
                            render: function(data, type, row) {
                                return "<span>" + row.old_matic_address + "</span>";
                            }
                        },
                        {
                            render: function(data, type, row) {
                                return "<span>" + row.new_matic_address + "</span>";
                            }
                        },
                        {
                            render: function(data, type, row) {
                                return "<span>" + row.old_usdt_bep20_address + "</span>";
                            }
                        },
                        {
                            render: function(data, type, row) {
                                return "<span>" + row.new_usdt_bep20_address + "</span>";
                            }
                        },
                        {
                            render: function(data, type, row) {
        ...
        function exportToExcel() {
            ...
            $.ajax({
                ...
                success: function(resp) {
                    ...
                    fileLink.setAttribute('download', 'Edit-User-Address-Report.xls');
        ...
        $("#onResetClick").click(function() {
            ...
            $('#edit-user-profile-report').DataTable().ajax.reload(null, false);
        });
