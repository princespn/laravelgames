        ...
        <div class="col-12">
            <div class="admin-card">
                <div class="admin-card-header">
                    <h4 class="card-title">Old Profile Report</h4>
                </div>
                <form id="searchForm">
                    <div class="row">
                        <div class="col-md-12">
        ...
        function roiIncomeReport() {
            ...
            setTimeout(function() {
                const table = $("#edit-user-profile-report").DataTable({
                    ...
                    ajax: {
                        url: '{{ url('1Rto5efWp86Z/getuserlogs') }}',
                        type: "POST",
                        headers: {
                    ...
                    columns: [{
                        ...
                        },
                        {
                            render: function(data, type, row) {
                                if (row.entry_time === null || row.entry_time === undefined ||
                                    row
                                    .entry_time === '') {
                                    return "-";
                                } else {
                        ...
                        {
                            render: function(data, type, row) {
                                return "<span>" + row.old_usdt_trc20_address + "</span>";
                            }
                        },
                        {
                            render: function(data, type, row) {
