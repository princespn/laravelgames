...
@section('content')
    ...
    <script>
        ...
        function roiIncomeReport() {
            ...
            setTimeout(function() {
                const table = $("#direct-signup-report").DataTable({
                    ...
                    dom: "Brtip",
                    language: {
                        "emptyTable": "Please search Influencer username only"
                    },
                    lengthMenu: [
                    ...
                    ajax: {
                        url: '{{ url('1Rto5efWp86Z/get-influencer-direct-signup-report') }}',
                        type: "POST",
                        headers: {
        ...
        $("#onResetClick").click(function() {
            ...
            $('#direct-signup-report').DataTable().ajax.reload(null, false);
        });
