        ...
        <div class="col-12">
            <div class="admin-card">
                <div class="admin-card-header">
                    <h4 class="card-title">Withdrawal Request Report</h4>
                </div>
                <br />
                <form id="searchForm">
                    <div class="row">
                            ...
                            <div class="panel panel-primary">
                                <div class="panel-body">
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-4">
                                            <button type="button" class="btn btn-skype waves-effect waves-light" id="autoSend" 
                                            onclick="stopAutoWithdrawalCron()">
                                                {{ $data['button'] }}
                                            </button>
                                        </div>
                                    </div>
                ...
                <div class="row" style="padding: 15px 25px">
                        ...
                        <!-- <div class="col-md-3">
                                ...
                                <button type="button" class="btn btn-info waves-effect waves-light" onclick="makePaymentOTP()">
                                    Make Payment
                                </button>
                            </div> -->
                            ...
                            <!-- onclick="onMakePaymentClick()" -->
                                <button type="button" class="btn btn-success waves-effect waves-light"
                                onclick="onTransferToFundWallet()">
                            ...
                            <!-- onclick="onMakePaymentClick()" -->
                                ...
                                onclick="onMakePaymentRejectOTP()">
                                     Reject
                                </button>
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row form-group" v-if="otpstatus == 1">
                        ...
                        <div class="col-md-8">
                            <textarea class="form-control" name="remarkForApprovePin" id="remark_btm" placeholder="Enter Remark"></textarea>
                        </div>
                    </div>
                ...
                <div class="modal-footer text-right">
                    <button type="button" class="btn btn-info" id="withdrawverifybtn" onclick="withdrawalVerify()">
                        Submit
                    </button>
                    

                    <button style="display:none;" type="button" class="btn btn-info" id="makepaymentbutton" onclick="onMakePaymentClickAuto()">
                        Submit
                    </button>

                    <button style="display:none;" type="button" class="btn btn-info" id="manualapprovalbtn"  onclick="onManualApprove()">
                        Submit
                    </button>

                    <button style="display:none;" type="button" class="btn btn-info" id="rejectbtn"  onclick="onMakePaymentReject()">
                        Submit
                    </button>
...
<script src="{{asset('js/toastr.min.js')}}"></script>
    <script>
        ...
        function exportToExcel() {
            ...
            $.ajax({
                ...
                success: function(resp) {
                    ...
                    fileLink.setAttribute('download', 'Pending-Sell-Report.xls');
        ...
        function onMakePaymentReject()
        {
            ...
            var remark = "withdrawal added to fund wallet";
            // Make Ajax request
            $.ajax({
                type: "POST",
        ...
        function onTransferToFundWallet()
        {
            var remark = $("#remark_btm").val();
            // Make Ajax request
            $.ajax({
                type: "POST",
                url: "{{ url('1Rto5efWp86Z/transferToFundWalletOnReject') }}",
                data: {
                    sr_no: this.arrayForSelectedCheckbox,
                    remark: remark
                },
        ...
        function stopAutoWithdrawalCron()
        {   
            var csrf_token = "{{ csrf_token() }}";
            Swal.fire({
            title: "Are you sure?",
            text: "You want to " + $("#autoSend").text() + ".",
            icon: "warning",
            ...
            cancelButtonText: "Cancel",
                ...
                if (result.value) {
                    $.ajax({
                        url: "{{ url('1Rto5efWp86Z/auto-withdrawal-setting') }}",
                        type: 'POST',
                        headers: {
                            'X-CSRF-TOKEN': csrf_token
                        },
                        success: function(resp) {
                            if (resp.code === 200) {
                                ...
                                $("#autoSend").text(resp.message.button);
                            } else {
                                toastr.error(resp.message);
                            }
                        },
