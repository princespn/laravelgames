        ...
        <div class="col-12">
            <div class="admin-card">
                <div class="admin-card-header">
                    <h4 class="card-title">Unpaid Confirm Sell Report</h4>
                </div>
                <br />
                <form id="searchForm">
                    <div class="row">
        ...
        function withdrawRequestReport() {
            ...
            setTimeout(function() {
                const table = $("#withdraw-request-report").DataTable({
                    ...
                    ajax: {
                        url: '{{ url('1Rto5efWp86Z/unpaid-confirm-sell') }}',
                        type: "POST",
                        headers: {
        ...
        function exportToExcel() {
            ...
            $.ajax({
                ...
                success: function(resp) {
                    ...
                    fileLink.setAttribute('download', 'Unpaid-Confirm-Sell-Report.xls');
