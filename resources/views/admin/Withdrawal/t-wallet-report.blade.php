...
@section('content')
        ...
        <div class="col-12">
            <div class="admin-card">
                <div class="admin-card-header">
                    <h4 class="card-title">T Wallet Report</h4>
                </div>
                <br />
                <form id="searchForm">
                    <div class="row">
                ...
                <div class="admin-card-body">
                    <div class="table-responsive admin-table">
                        <table id="t-wallet-report" class="display nowrap" style="width: 100%">
                            <thead>
                                <tr>
                                    <th>Sr.No</th>
                                    <th>Date</th>
    ...
    <script>
        ...
        function withdrawRequestReport() {
            ...
            setTimeout(function() {
                const table = $("#t-wallet-report").DataTable({
                    responsive: true,
                    retrieve: true,
                    destroy: true,
                    processing: false,
                    ...
                    ajax: {
                        url: '{{ url('1Rto5efWp86Z/t-wallet-data') }}',
                        type: "POST",
                        headers: {
                ...
                $.ajax({
                    ...
                    success: function(resp) {
                        if (resp.code === 200) {
                            ...
                            $('#adminOTP').val("");
                            toastr.success(resp.message);
                            var table = $("#t-wallet-report").DataTable();
                            table.ajax.reload(null, false);
                            $("#releasebtn").prop("disabled", false);
                        } else {
                            toastr.error(resp.message);
        ...
        function exportToExcel() {
            ...
            $.ajax({
                ...
                success: function(resp) {
                    ...
                    fileLink.setAttribute('download', 'T-Wallet-Report.xls');
