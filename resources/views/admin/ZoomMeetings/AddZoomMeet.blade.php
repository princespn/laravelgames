        ...
        <div class="col-6 mx-auto">
          <div class="admin-card">
            <div class="admin-card-header">
              <h4 class="card-title">Add Zoom Meeting</h4>
            </div>           
            <div class="admin-card-body">
              <form class="row g-3"  id="myform" method="post" action="{{url('1Rto5efWp86Z/submit-zoom-meeting')}}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group col-12">
                  ...
                  <input
                    ...
                    value="{{ old('zoom_meeting_password') }}" 
