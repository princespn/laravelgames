        ...
        <div class="col-6 mx-auto">
          <div class="admin-card">
            ...
            <div class="admin-card-body">
              <form class="row g-3"  id="myform" method="post" action="{{url('1Rto5efWp86Z/update-zoom-meeting-completed')}}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group col-12">
                  <label for="recorded_session_youtube_link">Youtube Recorded Meeting Link</label>
                  <input
                    type="text"
                    class="admin-form-control"
                    id="recorded_session_youtube_link"
                    name="recorded_session_youtube_link"
                    value="{{ $data['zoommeeting']->recorded_session_youtube_link }}" 
                    placeholder="Youtube Recorded Meeting Link"
                    required                
                  />
                    <div class="tooltip1">
                        <span class="text-danger" id="recorded_session_youtube_link-err"></span>
                    </div>
                </div>
