            ...
            <div class="admin-card-body">
                <form class="row g-3" id="change-user-id">
                    <div class="col-12">
                        ...
                        <input type="text" class="admin-form-control" id="username" placeholder="User ID" value="{{$user['user_id']}}"
...
function changeUserId() {
    ...
    Swal.fire({
      ...
      if (result.value) {
        ...
        $.ajax({
          url: '{{url('/1Rto5efWp86Z/updateUserId')}}',
          method: 'POST',
          data: data,
          success: (resp) => {
            if (resp.code === 200) {
