        ...
        <div class="col-12">
            <div class="admin-card">
                <div class="admin-card-header">
                    <h4 class="card-title">Auto Sell History</h4>
                </div>
                <form id="searchForm">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="panel panel-primary">
                                ...
                                "
                                            ...
                                            <div class="col-md-3 badge-circle">
                                                <h5 id="total_withdrawal_amount"></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            ajax: {
                ...
                dataSrc: function(json) {
                    if (json.code === 200) {
                        ...
                        $('#total_withdrawal_amount').text('Total Withdrawal Amount : ' + json.data.total_withdrawal_amount);
        ...
        $.ajax({
            ...
            success: function(resp) {
                if (resp.code === 200) {
                    ...
                    fileLink.setAttribute("download", "AutoSellData.xls");
