        ...
        <div class="col-12">
            <div class="admin-card">
                <div class="admin-card-header">
                    <h4 class="card-title">Binary Recovery Report</h4>
                </div>
                <form id="searchForm">
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <table id="binary-income-report" class="display nowrap" style="width: 100%">
                            <thead>
                                <tr>
                                    ...
                                    <th>Binary Deduction Amount</th>
                                    <th>Company Recovery Amount</th>
                                    <th>Pending Recovery Amount</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        var reportsTable = $("#binary-income-report").DataTable({
            ...
            ajax: {
                url: '{{ url('1Rto5efWp86Z/binary-recovery-data') }}',
                type: "POST",
                data: function(d) {
                    i = 0;
                    i = d.start + 1;
            ...
            columns: [{
                ...
                {
                    data: "binary_deduction_upto_amount"
                },
                {
                    data: "total_company_recover_amount"
                },
                {
                    data: "binary_deduction_upto_amount",
                    render: function (data, type, row) {
                        var binaryDeduction = parseFloat(data) || 0;
                        var companyRecover = parseFloat(row.total_company_recover_amount) || 0;
                        var result = binaryDeduction - companyRecover;
        ...
        $.ajax({
            ...
            success: function(resp) {
                if (resp.code === 200) {
                    ...
                    fileLink.setAttribute("download", "BinaryRecoveryData.xls");
