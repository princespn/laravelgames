        ...
        <div class="col-12">
            <div class="admin-card">
                <div class="admin-card-header">
                    <h4 class="card-title">Rank Reward Report</h4>
                </div>
                <form id="searchForm">
                    <div class="row">
                        <div class="col-md-12">
...
<script>
    ...
    $(document).ready(function () {
        ...
        var i = 0;
        var reportsTable = $("#rank-reward-report").DataTable({
            responsive: true,
            lengthMenu: [
                [10, 20, 30, 40, 50, 100],
                [10, 20, 30, 40, 50, 100],
            ...
            ajax: {
                url: '{{url('1Rto5efWp86Z/rank-reward-data')}}',
                type: "POST",
                data: function (d) {
                    i = 0;
                    i = d.start + 1;
