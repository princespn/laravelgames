        ...
        <div class="col-12">
            <div class="admin-card">
                <div class="admin-card-header">
                    <h4 class="card-title">Real Virtual Business Report</h4>
                </div>
                <form id="searchForm">
                    <div class="row">
                        <div class="col-md-12">
...
<script>
    $(document).ready(function() {
        ...
        var reportsTable = $("#binary-income-report").DataTable({
            ...
            ajax: {
                url: '{{ url('1Rto5efWp86Z/real-virtual-business-data') }}',
                type: "POST",
                data: function(d) {
                    i = 0;
                    i = d.start + 1;
        ...
        $.ajax({
            ...
            success: function(resp) {
                if (resp.code === 200) {
                    ...
                    fileLink.setAttribute("download", "RealVirtualBusinessReport.xls");
