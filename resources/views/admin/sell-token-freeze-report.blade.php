        ...
        <div class="col-12">
            <div class="admin-card">
                <div class="admin-card-header">
                    <h4 class="card-title">Sell Token Freeze Report</h4>
                </div>
                <form id="searchForm">
                    <div class="row">
                        <div class="col-md-12">
                ...
                <div class="admin-card-body">
                    <div class="table-responsive admin-table">
                        <table id="sell-token-report" class="display nowrap" style="width: 100%">
                            <thead>
                                <tr>
                                    <th>Sr.No</th>
                                    <th>User Id</th>
                                    <th>Sell Token Freeze</th>
                                    <th>Binary Token Freeze</th>
                                    <th>Available Sell Token</th>
                                    <th>Available Binary Token</th>
                                    <th>Date</th>
                                </tr>
                            </thead>
                        </table>
...
<script>
    $(document).ready(function() {
        ...
        var i = 0;
        var reportsTable = $("#sell-token-report").DataTable({
            responsive: true,
            lengthMenu: [
            ...
            ajax: {
                url: '{{ url('1Rto5efWp86Z/sellTokenFreezeReportData') }}',
            ...
            columns: [{
                ...
                {
                    data: "available_sell_token"
                },
                {
                    data: "available_binary_token"
                },
                {
                    data: "sell_token_freeze"
                },
                {
                    data: "binary_token_freeze"
                },
                {
                    data: "entry_time",
            ...
            $.ajax({
                ...
                success: function(resp) {
                    if (resp.code === 200) {
                        ...
                        fileLink.setAttribute("download", "SellTokenFreeze.xls");
