        ...
        <div class="col-12">
            <div class="admin-card">
                <div class="admin-card-header">
                    <h4 class="card-title">Sell Token Limit Report</h4>
                </div>
                <form id="searchForm">
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <table id="sell-token-report" class="display nowrap" style="width: 100%">
                            <thead>
                                <tr>
                                    ...
                                    <th>Date</th>
                                    <th>Username</th>
                                    <th>Sell Token Limit</th>
                                    <th>Binary Token Limit</th>
                                </tr>
                            </thead>
                        </table>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        var reportsTable = $("#sell-token-report").DataTable({
            ...
            ajax: {
                url: '{{ url('1Rto5efWp86Z/sellTokenLimitReportData') }}',
            ...
            columns: [{
                ...
                {
                    data: "sell_token_limit"
                },
                {
                    data: "binary_token_limit"
                },
            ...
            $.ajax({
                ...
                success: function(resp) {
                    if (resp.code === 200) {
                        ...
                        fileLink.setAttribute("download", "SellTokenLimit.xls");
