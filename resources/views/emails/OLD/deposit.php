...
<head>
   <title>Energeios | Deposit Mail</title>
            ...
            <td>
               <div>
                  <ul style="background: #dc9f17;color: white;padding: 10px 60px;width: 80%;margin: auto;" >
                     <li style="list-style-type: none;background: #1a1919;border-radius: 5px;padding: 5px 10px;margin: 2px auto;"> Package of '.$Package.' and '.$amount.' has been activated in your account of Username '.$username.'.  </li>
