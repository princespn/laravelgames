      ...
      <tbody style="min-height: 568px;background-size: contain;
         ...
         <tr>
            <td>
               ...
               <p style="text-align: center; font-size: 15px;letter-spacing: 0px;color: #F8F8F8;margin:0px 20px;"> We are happy to tell you that your call back on Energeios is successfully done. </p>
            </td>
         </tr>
         <tr>
            <td>
