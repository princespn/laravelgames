   ...
   <body>
      <div style="display: flex; align-items: center; justify-content: center; flex-direction: column; margin-top: 1.25rem; font-family: Nunito, sans-serif">
         <section style="max-width: 42rem; background-color: #fff;border: 1px solid #2e2e2e;">
            ...
            <h2 style="color: #374151;padding-left: 1.25rem; padding-right: 1.25rem;">Subject: Your Registration Has Been Successfully Done!</h2>
            ...
            Great news! Your profile has been successfully updated on the Energeios platform. Your information is now current and accurate, ensuring a seamless and personalized investment experience tailored just for you.
            </p>
            ...
            <p class="" style="padding-left: 1.25rem; padding-right: 1.25rem;">Your Username : '. $username.' </p>
            <p class="" style="padding-left: 1.25rem; padding-right: 1.25rem;">Your Password : '. $password.' </p>
             <p class="" style="padding-left: 1.25rem; padding-right: 1.25rem;">Your Password : '. $email.' </p>
         


            <p style="margin-top: 1rem; line-height: 1.75; color: #4b5563;padding-left: 1.25rem; padding-right: 1.25rem;">
              At Energeios, we prioritize the security and customization of your investment journey. With your profile updated, you are all set to explore the wide array of investment opportunities available to you.
            </p>


            <p style="margin-top: 1rem; line-height: 1.75; color: #4b5563;padding-left: 1.25rem; padding-right: 1.25rem;">Ready to embark on your investment journey with confidence? Dive in today!
            </p>
            ...
            <p style="margin-top: 1rem; line-height: 1.75; color: #4b5563;padding-left: 1.25rem; padding-right: 1.25rem;">For quick and convenient assistance, dont forget you can also contact our support team on WhatsApp at <a href="https://wa.me/9293339296" target="_blank">+929 333 9296</a> .</p>

            <p style="margin-top: 1rem; line-height: 1.75; color: #4b5563;padding-left: 1.25rem; padding-right: 1.25rem;">Thank you for entrusting Energeios with your investment aspirations. We are excited to accompany you on this journey to financial success!</p>
            ...
            <footer style="margin-top: 1rem;">
               <div style="background-color: #2e2e2e; padding-top :2px; padding-bottom : 2px; color: #fff; text-align: center;">
                  <p class="footertext">© 2024 Energeios. All Rights Reserved.</p>
               </div>
            </footer>
         </section>
      </div>
