...
<head>
   <title>Energeios | Registration OTP Mail</title>
      ...
      <tbody style="min-height: 568px;background-size: contain;
         ...
         <tr>
            <td>
               ...
               <p style="text-align: center; font-size: 15px;letter-spacing: 0px;color: #F8F8F8;margin:0px 20px;">Have you attempted to open a new account with HIGH-OCEAN?</p>
               <h5 style="text-align: center;letter-spacing: 0px;font-size: 15px;color: #fff;">
                  If so, use the code below to continue.
               </h5>
            </td>
         </tr>
         <tr>
            <td>
               <div>
                  <ul style="background: #dc9f17;color: white;padding: 10px 60px;width: 80%;margin: auto;" >
                     <li style="list-style-type: none;background: #1a1919;border-radius: 5px;padding: 5px 10px;margin: 2px auto;">Your OTP : ' . $otp . ' </li>
                  </ul>
               </div>
            </td>
         </tr>
