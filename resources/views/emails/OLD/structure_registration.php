...
<head>
   <title>Energeios | Structure Creation Mail</title>
      ...
      <tbody style="min-height: 568px;background-size: contain;
         ...
         <tr>
            <td>
               ...
               <p style="text-align: center; font-size: 15px;letter-spacing: 0px;color: #F8F8F8;margin:0px 20px;">We appreciate your registration on our website .</p>
               <h5 style="text-align: center;letter-spacing: 0px;font-size: 15px;color: #fff;">
                  Your login information to access Energeios account is as follows.
               </h5>
            </td>
         </tr>
         <tr>
            <td>
               <div>
                  <ul style="background: #dc9f17;color: white;padding: 10px 60px;width: 80%;margin: auto;" >
                     <li style="list-style-type: none;background: #1a1919;border-radius: 5px;padding: 5px 10px;margin: 2px auto;"> No. of IDs in structure : ' .$no_of_id. '</li>

                     <li style="list-style-type: none;background: #1a1919;border-radius: 5px;padding: 5px 10px;margin: 2px auto;"> Password : ' .$password. '</li>

                     <li style="list-style-type: none;background: #1a1919;border-radius: 5px;padding: 5px 10px;margin: 2px auto;"> Email: '.$user_email.' </li>
         ...
         <tr>
            <td>
               <p style="color:#FFFFFF"> <span style="color:#ED04B6">Please Note</span>
                  <br>Do not share your account details with anyone, because of security purposes. 
               </p>
               <p style="color:#FFFFFF;font-size: 13px;"> <strong>Important : </strong> If there’s any error in your login credentials or you’d like to change your login details. Please get in touch with our support team at: support@highocean.io </p>
