...
<head>
   <title>Energeios | Password Reset Successfully Mail</title>
      ...
      <tbody style="min-height: 568px;background-size: contain;
         ...
         <tr>
            <td>
               ...
               <p style="text-align: center; font-size: 15px;letter-spacing: 0px;color: #F8F8F8;margin:0px 20px;">We appreciate you using the password recovery feature.</p>
               <h5 style="text-align: center;letter-spacing: 0px;font-size: 15px;color: #fff;">
                 Password successfully changed for you on Energeios Platform.
               </h5>
            </td>
         </tr>
         <tr>
            <td>
               <div>
                  <ul style="background: #dc9f17;color: white;padding: 10px 60px;width: 80%;margin: auto;" >
                     <li style="list-style-type: none;background: #1a1919;border-radius: 5px;padding: 5px 10px;margin: 2px auto;"> Your password has been successfully updated.</li>
