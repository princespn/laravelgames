...
<head>
   <title>Energeios | Withdrawal Approved Mail</title>
      ...
      <tbody style="min-height: 568px;background-size: contain;
         ...
         <tr>
            <td>
              ...
              <p style="color:#fff;"> Your request for a withdrawal has been granted. </p>
            ...
            <td>
               <div>
                  <ul style="background: #dc9f17;color: white;padding: 10px 60px;width: 80%;margin: auto;" >
                    <li style="list-style-type: none;background: #1a1919;border-radius: 5px;padding: 5px 10px;margin: 2px auto;"> Within the allotted time, your money will be properly put in your account.
</li>
