...
<html lang="en">
   <head>
      ...
      <title>Profile Update Successfully Mail</title>
   ...
   <body>
      <div style="display: flex; align-items: center; justify-content: center; flex-direction: column; margin-top: 1.25rem; font-family: Nunito, sans-serif">
         <section style="max-width: 42rem; background-color: #fff;border: 1px solid #2e2e2e;">
            ...
            <h2 style="color: #374151;padding-left: 1.25rem; padding-right: 1.25rem;">Subject: Your Profile Has Been Successfully Updated!</h2>
            ...
            <p class="" style="padding-left: 1.25rem; padding-right: 1.25rem;">Date of Update : '. $date.' </p>
            <p class="" style="padding-left: 1.25rem; padding-right: 1.25rem;">Updated Information: [Specify Updated Information]</p>
