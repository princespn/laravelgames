...
<html lang="en">
   <head>
      ...
      <title>Withdrawal Processed Mail</title>
   ...
   <body>
      <div style="display: flex; align-items: center; justify-content: center; flex-direction: column; margin-top: 1.25rem; font-family: Nunito, sans-serif">
         <section style="max-width: 42rem; background-color: #fff;border: 1px solid #2e2e2e;">
            ...
            <h2 style="color: #374151;padding-left: 1.25rem; padding-right: 1.25rem;">Subject: Withdrawal Processed Successfully</h2>
            ...
            <p style="line-height: 1.5; color: #4b5563;padding-left: 1.25rem; padding-right: 1.25rem;">
               Exciting news from Energeios! Your withdrawal request has been successfully processed, and your funds are on their way to you.
            </p>
            <p style="line-height: 1.5; color: #4b5563;padding-left: 1.25rem; padding-right: 1.25rem;">
              Transaction Details:
            </p>
            ...
            <p style="margin-top: 1rem; line-height: 1.75; color: #4b5563;padding-left: 1.25rem; padding-right: 1.25rem;">
               Your satisfaction and security are our top priorities. If you have any questions or concerns regarding your withdrawal, please dont hesitate to contact us at support@energeios.io. Our dedicated support team is always here to assist you.
            </p>


            <p style="margin-top: 1rem; line-height: 1.75; color: #4b5563;padding-left: 1.25rem; padding-right: 1.25rem;">Thank you for choosing Energeios for your investment needs. We look forward to serving you again in the future.
            </p>


            <p style="margin-top: 1rem; line-height: 1.75; color: #4b5563;padding-left: 1.25rem; padding-right: 1.25rem;">Happy Investing!</p>
