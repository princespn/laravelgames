            ...
            <div class="card custom-card">
               ...
               <div class="card-body">
                <div class="table-responsive">
                     <table id="buy-sell-report" class="table table-bordered text-nowrap w-100" style="width:100%">
                        <thead>
                        <tr>
                             <th>No.</th>
                             <th>Date</th>
...
<script type="text/javascript">
   ...
   $(document).ready(function () {
       ...
       var i = 0;
       var reportsTable = $("#buy-sell-report").DataTable({
           responsive: true,
           // lengthMenu: [
           //     [10, 20, 30, 40, 50, 100],
           // ],
           ...
           ajax: {
               url: '{{ url('/reports/coin-chart-reports-data')}}',
               type: "POST",
               data: function (d) {
                   i = 0;
                   i = d.start + 1;
