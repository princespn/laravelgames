              ...
              <div class="row">
                ...
                <div class="col-6">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"> Structure Report</li>
                  </ol>
                </div>
              </div>
            </div>
            ...
            <div class="card custom-card ccd">
               <div class="card-body">
                  <div class="table-responsive">
                     <table id="downline-topup-report" class="display nowrap table table-bordered text-nowrap w-100" style="width:100%">
                        <thead>
                        <tr>
                              <th>
                              ...
                              <th>
                                 <div class="d-flex align-items-center">  <span class="icon-user me-1 fs-5s"></span> Station ID </div>
                              </th>
                           
                              <th>
                                 <div class="d-flex align-items-center">  <span class="icon-local_atm me-1 fs-5s"></span>Amount </div>
                              </th>
                              <!-- <th>
                                 <div class="d-flex align-items-center">  <span class="icon-local_atm me-1 fs-5s"></span>Transaction ID</div>
                              </th> -->
                           {{--
                              <th>
                                 <div class="d-flex align-items-center">  <span class="icon-auto_stories me-1 fs-5s"></span>Personal Note </div>
                              </th> --}}
                           </tr>
                        </thead>
                     </table>
