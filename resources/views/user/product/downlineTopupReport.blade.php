              ...
              <div class="row">
                ...
                <div class="col-6">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"> Top Up Summary</li>
                  </ol>
                </div>
              </div>
            </div>
            ...
            <div class="card custom-card ccd">
               <div class="card-body">
                  ...
                  <div class="table-responsive">
                     <table id="downline-topup-report" class="table table-bordered text-nowrap w-100" style="width:100%">
                        <thead>
                           <tr>
                              <th>
        ...
        $(document).ready(function(){
            ...
            var reportsTable = $("#downline-topup-report").DataTable({
                ...
                columns: [
                    ...
                    { render: function (data, type, row,) {
                            return `<span>${Number(row.buy_coin).toFixed(11)}</span>  `;
                        }
                    },
                    { render: function (data, type, row,) {
