         ...
         <div class="row">
            <div class="col-12">
               <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                  <h4 class="mb-sm-0">Daily Binary Distribution</h4>
                  <div class="page-title-right">
                     <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Pages</a></li>
                        <li class="breadcrumb-item active">Daily Binary Distribution</li>
                     </ol>
                  </div>
               </div>
            </div>
         ...
         <div class="row">
            <div class="col-lg-12">
               <div class="card">
                  ...
                  <div class="card-body">
                     <table id="daily-bonus-report" class="table nowrap align-middle" style="width:100%">
                        <thead>
                        <tr>
                        <th>No.</th>
                        <th>Date</th>
...
<script type="text/javascript">
   ...
   $(document).ready(function () {
       ...
       var i = 0;
       var reportsTable = $("#daily-bonus-report").DataTable({
           responsive: true,
           // lengthMenu: [
           //     [10, 20, 30, 40, 50, 100],
           // ],
           ...
           ajax: {
               url: '{{ url('/reports/daily-bonus-data')}}',
               type: "POST",
               data: function (d) {
                   i = 0;
                   i = d.start + 1;
           ...
           columns: [
               ...
               {
                   render: function (data, type, row) {
                       return `<span>${Number(row.daliy_binary_income).toFixed(2)}</span>`;
                   },
               },

               {
                   render: function (data, type, row) {
                       return `<span>${Number(row.lapse_amount).toFixed(2)}</span>`;
                   }
               },
