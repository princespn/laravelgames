...
<script type="text/javascript">
   ...
   $(document).ready(function () {
       ...
       var reportsTable = $("#roi-report").DataTable({
           ...
           ajax: {
               url: '{{url('/differentiate-income-reports')}}',
               type: "POST",
               data: function (d) {
                   i = 0;
                   i = d.start + 1;
           ...
           columns: [
               ...
               {
                   render: function (data, type, row) {
                       return `<span>${Number(row.matching).toFixed(2)}</span>`;
                   }
               },
               ...
               {
                   render: function (data, type, row) {
                       return `<span>${Number(row.percentage).toFixed(2)}</span>`;
                   }
               },
               {
                   data: 'rank'
