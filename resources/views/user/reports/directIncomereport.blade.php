              ...
              <div class="row">
                ...
                <div class="col-6">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"> Direct Income Report</li>
                  </ol>
                </div>
              </div>
            </div>
         ...
         <div class="col-xl-12">
                        ...
                        <div class="col-md-3">
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="user_id" id="user_id"
                                 placeholder="From Station ID" maxlength="12" />
                           </div>
                        </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="card">
                  <div class="card-body">
                     <table id="direct-report" class="table table-bordered text-nowrap w-100" style="width:100%">
                        <thead>
                           <tr>
                              <th>
                              ...
                              <th>
                                 <div class="d-flex align-items-center">  <span class="icon-calendar me-1 fs-5s"></span>Amount </div>
                              </th>
                              <th>
                                 <div class="d-flex align-items-center">  <span class="icon-calendar me-1 fs-5s"></span>Percentage </div>
                              </th>
                              {{-- <th>
                                 <div class="d-flex align-items-center">  <span class="icon-calendar me-1 fs-5s"></span>Lapse Amount </div>
                              </th> --}}
                              <th>
                                 <div class="d-flex align-items-center">  <span class="icon-calendar me-1 fs-5s"></span>On Amount </div>
                              </th>
                              <th>
                                 <div class="d-flex align-items-center">  <span class="icon-calendar me-1 fs-5s"></span>From Station ID </div>
                              </th>
                              <th>
...
<script type="text/javascript">
   ...
   $(document).ready(function () {
       ...
       var i = 0;
       var reportsTable = $("#direct-report").DataTable({
           responsive: true,
           // lengthMenu: [
           //     [10, 20, 30, 40, 50, 100],
           // ],
           ...
           ajax: {
               url: '{{ url('/reports/direct-reports-data')}}',
               type: "POST",
               data: function (d) {
                   i = 0;
                   i = d.start + 1;
...
{{--
 ...
 --}}
               {
                   render: function (data, type, row) {
                       return `<span>${Number(row.on_amount).toFixed(2)}</span>`;
                   },
               },
