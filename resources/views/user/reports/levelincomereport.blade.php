         ...
         <div class="row">
            <div class="col-12">
               <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                  <h4 class="mb-sm-0">Level ROI Income</h4>
                  <div class="page-title-right">
                     <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Pages</a></li>
                        <li class="breadcrumb-item active">Level ROI Income</li>
                     </ol>
                  </div>
               </div>
            </div>
         ...
         <div class="row">
            <div class="col-lg-12">
               <div class="card">
                  ...
                  <div class="card-body">
                     <table id="direct-report" class="table nowrap align-middle" style="width:100%">
                        <thead>
                        <tr>
                          <th>No.</th>
                          <th>Date</th>
...
<script type="text/javascript">
   ...
   $(document).ready(function () {
       ...
       var reportsTable = $("#direct-report").DataTable({
           ...
           ajax: {
               url: '{{ url('/reports/level-roi-reports-data')}}',
               type: "POST",
               data: function (d) {
                   i = 0;
                   i = d.start + 1;
