         ...
         <div class="row">
            <div class="col-12">
               <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                  <h4 class="mb-sm-0">Weekly Royalty Bonus Distribution</h4>
                  <div class="page-title-right">
                     <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Pages</a></li>
                        <li class="breadcrumb-item active"> Weekly Royalty Bonus Distribution</li>
                     </ol>
                  </div>
               </div>
            </div>
...
<script type="text/javascript">
   ...
   $(document).ready(function () {
       ...
       var reportsTable = $("#daily-bonus-report").DataTable({
           ...
           ajax: {
               url: '{{ url('/reports/weekly-bonus-data')}}',
               type: "POST",
               data: function (d) {
                   i = 0;
                   i = d.start + 1;
