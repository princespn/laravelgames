   ...
   $(document).ready(function () {
       ...
       var reportsTable = $("#binary-report").DataTable({
           ...
           columns: [
               ...
               {
                   render: function (data, type, row) {
                       return `<span>${Number(row.amount).toFixed(11)}</span>`;
                   },
               },
               {
                   render: function (data, type, row) {
               ...
               {
                   render: function (data, type, row) {
                       return `<span>${Number(row.today_total_coin).toFixed(11)}</span>`;
                   }
               },
               {
                   render: function (data, type, row) {
                       return `<span>${Number(row.level_coin).toFixed(11)}</span>`;
                   }
               },
               {
                   render: function (data, type, row) {
                       return `<span>${Number(row.admin_coin).toFixed(11)}</span>`;
                   }
               },
