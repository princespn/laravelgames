        ...
        <div class="col-6">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="index.html">
              ...
              <li class="breadcrumb-item active">Station Tree</li>
            </ol>
          </div>
        </div>
      </div>
          ...
          <div class="profitTree">
            <div class="row midline">
              <div class="col-12">
                <div class="tree-level1">
                  <a href="javascript:void(0)" data-toggle="tooltip" data-placement="bottom" id="myTooltip1" class="mytooltip {{ strtolower($userdata->imageClass) }}">
                    <img src="{{asset('images/tree-view/'.$userdata->image)}}" onclick="getMatrixTreeData('{{$userdata->user_id}}')">
                    <div class="profitTree-info card shadow-sm p-3 ">
                      <div class="row">
                        <div class="col-4">
                          <div class="leftbarwrap">
                            <ul class="info-list">
                              <li class="info-item">
                                <div class="icon">
                                  <img src="{{ asset('/images/tree-view/placement.svg')}}">
                                </div>
                                <div>
                                  <span class="label">Placement Id</span><br>
                                  <span class="value">{{ $userdata->virtual_id ?? 'Absent' }}</span>
                                </div>
                              </li>
                              <li class="info-item active">
                                <div class="icon">
                                  <img src="{{ asset('/images/tree-view/total.svg')}}">
                                </div>
                                <div>
                                  <span class="label">Total Topup</span><br>
                                  <span class="value">{{ $userdata->selftopup ?? 'Absent' }}</span>
                                </div>
                              </li>
                              <li class="info-item">
                                <div class="icon">
                                  <img src="{{ asset('/images/tree-view/calendar.svg')}}">
                                </div>
                                <div>
                                  <span class="label">Topup Date</span><br>
                                  <span class="value">{{ $userdata->entry_time ?? 'Absent' }}</span>
                                </div>
                              </li>
                            </ul>
                          </div>
            ...
            <div class="row midline VHline">
              <div class="col-6 tree-2-1">
                <a href="javascript:void(0)" data-toggle="tooltip" data-placement="bottom" id="myTooltip1" class="mytooltip {{ strtolower($tree_data[0]['level'][0]->imageClass) }}">
                        ...
                        <div class="leftbarwrap">
                          <ul class="info-list">
                            <li class="info-item">
                              ...
                              <div>
                                <span class="label">Placement Id</span><br>
                                <span class="value">{{$tree_data[0]['level'][0]->virtual_id}}</span>
                              </div>
                            </li>
                            <li class="info-item active">
                              <div class="icon">
                              ...
                              <div>
                                <span class="label">Total Topup</span><br>
                                <span class="value">{{$tree_data[0]['level'][0]->selftopup}}</span>
                              </div>
                            </li>
                            <li class="info-item">
                              <div class="icon">
                              ...
                              <div>
                                <span class="label">Topup Date</span><br>
                                <span class="value">{{$tree_data[0]['level'][0]->entry_time}}</span>
                              </div>
                            </li>
                          </ul>
                        </div>
              ...
              <div class="col-6 tree-2-2">
                <a href="javascript:void(0)" data-toggle="tooltip" data-placement="bottom" id="myTooltip1" class="mytooltip {{ strtolower($tree_data[0]['level'][1]->imageClass) }}">
                        ...
                        <div class="leftbarwrap">
                          <ul class="info-list">
                            <li class="info-item">
                              ...
                              <div>
                                <span class="label">Placement Id</span><br>
                                <span class="value">{{$tree_data[0]['level'][1]->virtual_id}}</span>
                              </div>
                            </li>
                            <li class="info-item active">
                              <div class="icon">
                              ...
                              <div>
                                <span class="label">Total Topup</span><br>
                                <span class="value">{{$tree_data[0]['level'][1]->selftopup}}</span>
                              </div>
                            </li>
                            <li class="info-item">
                              <div class="icon">
                              ...
                              <div>
                                <span class="label">Topup Date</span><br>
                                <span class="value">{{$tree_data[0]['level'][1]->entry_time}}</span>
                              </div>
                            </li>
                          </ul>
                        </div>
              ...
              <div class="col-6">
                <div class="row midline VHline-3">
                  <div class="col-6 tree-3-1">
                    <a href="javascript:void(0)" data-toggle="tooltip" data-placement="bottom" id="myTooltip1" class="mytooltip {{ strtolower($tree_data[1]['level'][0]->imageClass) }}">
                            ...
                            <div class="leftbarwrap">
                              <ul class="info-list">
                                <li class="info-item">
                                  ...
                                  <div>
                                    <span class="label">Placement Id</span><br>
                                    <span class="value">{{$tree_data[1]['level'][0]->virtual_id}}</span>
                                  </div>
                                </li>
                                <li class="info-item active">
                                  <div class="icon">
                                  ...
                                  <div>
                                    <span class="label">Total Topup</span><br>
                                    <span class="value">{{$tree_data[1]['level'][0]->selftopup}}</span>
                                  </div>
                                </li>
                                <li class="info-item">
                                  <div class="icon">
                                  ...
                                  <div>
                                    <span class="label">Topup Date</span><br>
                                    <span class="value">{{$tree_data[1]['level'][0]->entry_time}}</span>
                                  </div>
                                </li>
                              </ul>
                            </div>
                  ...
                  <div class="col-6 tree-3-2">
                    <a href="javascript:void(0)" data-toggle="tooltip" data-placement="bottom" id="myTooltip1" class="mytooltip {{ strtolower($tree_data[1]['level'][1]->imageClass) }}">
                            ...
                            <div class="leftbarwrap">
                              <ul class="info-list">
                                <li class="info-item">
                                  ...
                                  <div>
                                    <span class="label">Placement Id</span><br>
                                    <span class="value">{{$tree_data[1]['level'][1]->virtual_id}}</span>
                                  </div>
                                </li>
                                <li class="info-item active">
                                  <div class="icon">
                                  ...
                                  <div>
                                    <span class="label">Total Topup</span><br>
                                    <span class="value">{{$tree_data[1]['level'][1]->selftopup}}</span>
                                  </div>
                                </li>
                                <li class="info-item">
                                  <div class="icon">
                                  ...
                                  <div>
                                    <span class="label">Topup Date</span><br>
                                    <span class="value">{{$tree_data[1]['level'][1]->entry_time}}</span>
                                  </div>
                                </li>
                              </ul>
                            </div>
              ...
              <div class="col-6">
                <div class="row midline VHline-3">
                  <div class="col-6 tree-3-3">
                    <a href="javascript:void(0)" data-toggle="tooltip" data-placement="bottom" id="myTooltip1" class="mytooltip {{ strtolower($tree_data[1]['level'][2]->imageClass) }}">
                            ...
                            <div class="leftbarwrap">
                              <ul class="info-list">
                                <li class="info-item">
                                  ...
                                  <div>
                                    <span class="label">Placement Id</span><br>
                                    <span class="value">{{$tree_data[1]['level'][2]->virtual_id}}</span>
                                  </div>
                                </li>
                                <li class="info-item active">
                                  <div class="icon">
                                  ...
                                  <div>
                                    <span class="label">Total Topup</span><br>
                                    <span class="value">{{$tree_data[1]['level'][2]->selftopup}}</span>
                                  </div>
                                </li>
                                <li class="info-item">
                                  <div class="icon">
                                  ...
                                  <div>
                                    <span class="label">Topup Date</span><br>
                                    <span class="value">{{$tree_data[1]['level'][2]->entry_time}}</span>
                                  </div>
                                </li>
                              </ul>
                            </div>
                  ...
                  <div class="col-6 tree-3-4">
                    <a href="javascript:void(0)" data-toggle="tooltip" data-placement="bottom" id="myTooltip1" class="mytooltip {{ strtolower($tree_data[1]['level'][3]->imageClass) }}">
                            ...
                            <div class="leftbarwrap">
                              <ul class="info-list">
                                <li class="info-item">
                                  ...
                                  <div>
                                    <span class="label">Placement Id</span><br>
                                    <span class="value">{{$tree_data[1]['level'][3]->virtual_id}}</span>
                                  </div>
                                </li>
                                <li class="info-item active">
                                  <div class="icon">
                                  ...
                                  <div>
                                    <span class="label">Total Topup</span><br>
                                    <span class="value">{{$tree_data[1]['level'][3]->selftopup}}</span>
                                  </div>
                                </li>
                                <li class="info-item">
                                  <div class="icon">
                                  ...
                                  <div>
                                    <span class="label">Topup Date</span><br>
                                    <span class="value">{{$tree_data[1]['level'][3]->entry_time}}</span>
                                  </div>
                                </li>
                              </ul>
                            </div>
              ...
              <div class="col-3">
                <div class="row midline VHline-4">
                  <div class="col-6 tree-4-1">
                    <a href="javascript:void(0)" data-toggle="tooltip" data-placement="bottom" id="myTooltip1" class="mytooltip {{ strtolower($tree_data[2]['level'][0]->imageClass) }}">
                            ...
                            <div class="leftbarwrap">
                              <ul class="info-list">
                                <li class="info-item">
                                  ...
                                  <div>
                                    <span class="label">Placement Id</span><br>
                                    <span class="value">{{$tree_data[2]['level'][0]->virtual_id}}</span>
                                  </div>
                                </li>
                                <li class="info-item active">
                                  <div class="icon">
                                  ...
                                  <div>
                                    <span class="label">Total Topup</span><br>
                                    <span class="value">{{$tree_data[2]['level'][0]->selftopup}}</span>
                                  </div>
                                </li>
                                <li class="info-item">
                                  <div class="icon">
                                  ...
                                  <div>
                                    <span class="label">Topup Date</span><br>
                                    <span class="value">{{$tree_data[2]['level'][0]->entry_time}}</span>
                                  </div>
                                </li>
                              </ul>
                            </div>
                  ...
                  <div class="col-6 tree-4-2">
                    <a href="javascript:void(0)" data-toggle="tooltip" data-placement="bottom" id="myTooltip1" class="mytooltip {{ strtolower($tree_data[2]['level'][1]->imageClass) }}">
                            ...
                            <div class="leftbarwrap">
                              <ul class="info-list">
                                <li class="info-item">
                                  ...
                                  <div>
                                    <span class="label">Placement Id</span><br>
                                    <span class="value">{{$tree_data[2]['level'][1]->virtual_id}}</span>
                                  </div>
                                </li>
                                <li class="info-item active">
                                  <div class="icon">
                                  ...
                                  <div>
                                    <span class="label">Total Topup</span><br>
                                    <span class="value">{{$tree_data[2]['level'][1]->selftopup}}</span>
                                  </div>
                                </li>
                                <li class="info-item">
                                  <div class="icon">
                                  ...
                                  <div>
                                    <span class="label">Topup Date</span><br>
                                    <span class="value">{{$tree_data[2]['level'][1]->entry_time}}</span>
                                  </div>
                                </li>
                              </ul>
                            </div>
              ...
              <div class="col-3">
                <div class="row midline VHline-4">
                  <div class="col-6 tree-4-3">
                    <a href="javascript:void(0)" data-toggle="tooltip" data-placement="bottom" id="myTooltip1" class="mytooltip {{ strtolower($tree_data[2]['level'][2]->imageClass) }}">
                            ...
                            <div class="leftbarwrap">
                              <ul class="info-list">
                                <li class="info-item">
                                  ...
                                  <div>
                                    <span class="label">Placement Id</span><br>
                                    <span class="value">{{$tree_data[2]['level'][2]->virtual_id}}</span>
                                  </div>
                                </li>
                                <li class="info-item active">
                                  <div class="icon">
                                  ...
                                  <div>
                                    <span class="label">Total Topup</span><br>
                                    <span class="value">{{$tree_data[2]['level'][2]->selftopup}}</span>
                                  </div>
                                </li>
                                <li class="info-item">
                                  <div class="icon">
                                  ...
                                  <div>
                                    <span class="label">Topup Date</span><br>
                                    <span class="value">{{$tree_data[2]['level'][2]->entry_time}}</span>
                                  </div>
                                </li>
                              </ul>
                            </div>
                  ...
                  <div class="col-6 tree-4-4">
                    <a href="javascript:void(0)" data-toggle="tooltip" data-placement="bottom" id="myTooltip1" class="mytooltip {{ strtolower($tree_data[2]['level'][3]->imageClass) }}">
                      ...
                      <div class="profitTree-info">
                        <div class="row">
                            ...
                            <div class="leftbarwrap">
                              <ul class="info-list">
                                <li class="info-item">
                                  ...
                                  <div>
                                    <span class="label">Placement Id</span><br>
                                    <span class="value">{{$tree_data[2]['level'][3]->virtual_id}}</span>
                                  </div>
                                </li>
                                <li class="info-item active">
                                  <div class="icon">
                                  ...
                                  <div>
                                    <span class="label">Total Topup</span><br>
                                    <span class="value">{{$tree_data[2]['level'][3]->selftopup}}</span>
                                  </div>
                                </li>
                                <li class="info-item">
                                  <div class="icon">
                                  ...
                                  <div>
                                    <span class="label">Topup Date</span><br>
                                    <span class="value">{{$tree_data[2]['level'][3]->entry_time}}</span>
                                  </div>
                                </li>
                              </ul>
                            </div>
                          ...
                          <div class="col-8">
                            <div class="rightbarwrap">
                              <div class="pi-info">
                                <h4>{{$tree_data[2]['level'][3]->fullname}} / {{$tree_data[2]['level'][3]->user_id}}</h4>
                              </div>
                              <div class="treetable">
                                <table class="table">
                                  <tbody>
                                    ...
                                    <tr>
                                      <td>Direct Users</td>
                                      @if($tree_data[2]['level'][3]->l_d_count == "Absent")
                                      <td>Absent</td>
                                      <td>Absent</td>
                                      @else
              ...
              <div class="col-3">
                <div class="row midline VHline-4">
                  <div class="col-6 tree-4-5">
                    <a href="javascript:void(0)" data-toggle="tooltip" data-placement="bottom" id="myTooltip1" class="mytooltip {{ strtolower($tree_data[2]['level'][4]->imageClass) }}">
                            ...
                            <div class="leftbarwrap">
                              <ul class="info-list">
                                <li class="info-item">
                                  ...
                                  <div>
                                    <span class="label">Placement Id</span><br>
                                    <span class="value">{{$tree_data[2]['level'][4]->virtual_id}}</span>
                                  </div>
                                </li>
                                <li class="info-item active">
                                  <div class="icon">
                                  ...
                                  <div>
                                    <span class="label">Total Topup</span><br>
                                    <span class="value">{{$tree_data[2]['level'][4]->selftopup}}</span>
                                  </div>
                                </li>
                                <li class="info-item">
                                  <div class="icon">
                                  ...
                                  <div>
                                    <span class="label">Topup Date</span><br>
                                    <span class="value">{{$tree_data[2]['level'][4]->entry_time}}</span>
                                  </div>
                                </li>
                              </ul>
                            </div>
                  ...
                  <div class="col-6 tree-4-6">
                    <a href="javascript:void(0)" data-toggle="tooltip" data-placement="bottom" id="myTooltip1" class="mytooltip {{ strtolower($tree_data[2]['level'][5]->imageClass) }}">
                            ...
                            <div class="leftbarwrap">
                              <ul class="info-list">
                                <li class="info-item">
                                  ...
                                  <div>
                                    <span class="label">Placement Id</span><br>
                                    <span class="value">{{$tree_data[2]['level'][5]->virtual_id}}</span>
                                  </div>
                                </li>
                                <li class="info-item active">
                                  <div class="icon">
                                  ...
                                  <div>
                                    <span class="label">Total Topup</span><br>
                                    <span class="value">{{$tree_data[2]['level'][5]->selftopup}}</span>
                                  </div>
                                </li>
                                <li class="info-item">
                                  <div class="icon">
                                  ...
                                  <div>
                                    <span class="label">Topup Date</span><br>
                                    <span class="value">{{$tree_data[2]['level'][5]->entry_time}}</span>
                                  </div>
                                </li>
                              </ul>
                            </div>
              ...
              <div class="col-3">
                <div class="row midline VHline-4">
                  <div class="col-6 tree-4-7">
                    <a href="javascript:void(0)" data-toggle="tooltip" data-placement="bottom" id="myTooltip1" class="mytooltip {{ strtolower($tree_data[2]['level'][6]->imageClass) }}">
                            ...
                            <div class="leftbarwrap">
                              <ul class="info-list">
                                <li class="info-item">
                                  ...
                                  <div>
                                    <span class="label">Placement Id</span><br>
                                    <span class="value">{{$tree_data[2]['level'][6]->virtual_id}}</span>
                                  </div>
                                </li>
                                <li class="info-item active">
                                  <div class="icon">
                                  ...
                                  <div>
                                    <span class="label">Total Topup</span><br>
                                    <span class="value">{{$tree_data[2]['level'][6]->selftopup}}</span>
                                  </div>
                                </li>
                                <li class="info-item">
                                  <div class="icon">
                                  ...
                                  <div>
                                    <span class="label">Topup Date</span><br>
                                    <span class="value">{{$tree_data[2]['level'][6]->entry_time}}</span>
                                  </div>
                                </li>
                              </ul>
                            </div>
                  ...
                  <div class="col-6 tree-4-8">
                    <a href="javascript:void(0)" data-toggle="tooltip" data-placement="bottom" id="myTooltip1" class="mytooltip {{ strtolower($tree_data[2]['level'][7]->imageClass) }}">
                            ...
                            <div class="leftbarwrap">
                              <ul class="info-list">
                                <li class="info-item">
                                  ...
                                  <div>
                                    <span class="label">Placement Id</span><br>
                                    <span class="value">{{$tree_data[2]['level'][7]->virtual_id}}</span>
                                  </div>
                                </li>
                                <li class="info-item active">
                                  <div class="icon">
                                  ...
                                  <div>
                                    <span class="label">Total Topup</span><br>
                                    <span class="value">{{$tree_data[2]['level'][7]->selftopup}}</span>
                                  </div>
                                </li>
                                <li class="info-item">
                                  <div class="icon">
                                  ...
                                  <div>
                                    <span class="label">Topup Date</span><br>
                                    <span class="value">{{$tree_data[2]['level'][7]->entry_time}}</span>
                                  </div>
                                </li>
                              </ul>
                            </div>
